                    ...
                    <table class="table table-striped" id="example2">
                        ...
                        <tbody>
                            <tr class="gradeA">
                                ...
                                <td>
                                    <a href="{{route('recruitments.edit')}}" class="btn btn-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                        </svg>
                                    </a>
                                    <a href="" class="btn btn-danger" role="button" data-toggle="modal" data-target="">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content" style="width: 800px;">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Tên công ty</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>Công Ty Cổ Phần Bán Lẻ Kỹ Thuật Số FPT / Địa chỉ: 261 - 263 Khánh Hội, P2, Q4, TP. Hồ Chí Minh </td>
                                                                <td>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</td>
                                                                <td>
                                                                    <img src="https://th.bing.com/th/id/OIP.BfXC9dMxogUllGLPl78NdgHaCY?w=335&h=112&c=7&r=0&o=5&pid=1.7" width="100px" height="60px" alt="">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
